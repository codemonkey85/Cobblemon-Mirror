    ...
    companion object {
        ...
        internal val CODEC: MapCodec<SpeciesP1> = RecordCodecBuilder.mapCodec { instance ->
            instance.group(
                ...
                CobblemonRegistries.ELEMENTAL_TYPE.byNameCodec().fieldOf("primaryType").forGetter(SpeciesP1::primaryType),
                CobblemonRegistries.ELEMENTAL_TYPE.byNameCodec().optionalFieldOf("secondaryType").forGetter(SpeciesP1::secondaryType),
