...
object CobblemonItemGroups {
    ...
    private fun blockEntries(displayContext: DisplayContext, entries: Entries) {
        ...
        entries.add(CobblemonItems.SMOOTH_TUMBLESTONE)
        entries.add(CobblemonItems.SMOOTH_TUMBLESTONE_STAIRS)
        entries.add(CobblemonItems.SMOOTH_TUMBLESTONE_SLAB)
        ...
        entries.add(CobblemonItems.SMOOTH_BLACK_TUMBLESTONE)
        entries.add(CobblemonItems.SMOOTH_BLACK_TUMBLESTONE_STAIRS)
        entries.add(CobblemonItems.SMOOTH_BLACK_TUMBLESTONE_SLAB)
        ...
        entries.add(CobblemonItems.SMOOTH_SKY_TUMBLESTONE)
        entries.add(CobblemonItems.SMOOTH_SKY_TUMBLESTONE_STAIRS)
        entries.add(CobblemonItems.SMOOTH_SKY_TUMBLESTONE_SLAB)
